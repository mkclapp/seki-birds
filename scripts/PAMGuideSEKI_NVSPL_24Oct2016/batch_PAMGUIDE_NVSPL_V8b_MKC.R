...
#V8_MKC- editing for my project
# Wed Feb 14 14:54:26 2018 ------------------------------
# Got error in testing 1 file that referred to line 405 in PAMGuide:
...
# LEWI dataset
WAVDirsDIR = "/Users/mary/Documents/GitHub/seki_birds/data/wav/listens_center_2015"  #choose.dir()
WAVDirs <- list.dirs(WAVDirsDIR)
filext = "%Y%m%d_%H%M%S_000.wav"
filpat = ".wav"
...
PAMdir = "/Users/mary/Documents/GitHub/seki_birds/scripts/PAMGuideSEKI_NVSPL_24Oct2016"
...
test  = 1  #set to 1 if you want to test a file
