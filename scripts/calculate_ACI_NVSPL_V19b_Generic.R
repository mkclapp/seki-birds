...
## -------------------------------------------------------------------------
## GET FILES
workingDir = choose.dir(caption = "Choose top directory with NVSPL files to process") #"E:\\NPS_DATA\\BioacousticPhenology\\ALL\\NVSPL_copy\\toProcess"
...
Outdir =  choose.dir(caption = "Choose directory to put Acoustic Index output files") #E:\\NPS_DATA\\BioacousticPhenology\\ALL\\ANALYSIS\\AcousticIndex"
...
for (ss in 1:length(mySites)  ) # 1:length(mySites) START loop through sites ss = 1
{
